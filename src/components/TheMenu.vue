<template>
  <div class="fab fab-flower !relative right-0 bottom-0 m-0 p-0">
    ...
    <div id="old" class="tooltip" data-tip="Fond">
      <button
        ...
        @click="toggleBackgroundControls"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
...
function toggleMediaControls() {
  panelSettings.media = !panelSettings.media
}
</script>
